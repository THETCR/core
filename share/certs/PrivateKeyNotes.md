...
unlocked to sign the Wispr-qt.app bundle.
...
allowing somebody to distribute a Wispr-qt.app or wispr-qt-setup.exe with a valid
...
that the wispr-qt.exe file inside the installer had not been tampered with.

...
void Test_RunAllTests()
{
    ...
    cout << endl
         << "Average coin size is " << gCoinSize << " bytes." << endl;
    ...
    cout << endl
         << gSuccessfulTests << " out of " << gNumTests << " tests passed." << endl
         << endl;
    delete g_Params;
}
...
{
    cout << "libzerocoin v" << ZEROCOIN_VERSION_STRING << " test utility." << endl
         << endl;

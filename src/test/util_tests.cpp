 ...
 * Put a std::string before and after to ensure sanity of element sizes on stack. */
...
BOOST_AUTO_TEST_CASE(test_FormatParagraph)
{
    ...
    BOOST_CHECK_EQUAL(FormatParagraph("This is a very long test std::string. This is a second sentence in the very long test std::string.", 79), "This is a very long test std::string. This is a second sentence in the very long\ntest std::string.");
    BOOST_CHECK_EQUAL(FormatParagraph("This is a very long test std::string.\nThis is a second sentence in the very long test std::string. This is a third sentence in the very long test std::string.", 79), "This is a very long test std::string.\nThis is a second sentence in the very long test std::string. This is a third\nsentence in the very long test std::string.");
    BOOST_CHECK_EQUAL(FormatParagraph("This is a very long test std::string.\n\nThis is a second sentence in the very long test std::string. This is a third sentence in the very long test std::string.", 79), "This is a very long test std::string.\n\nThis is a second sentence in the very long test std::string. This is a third\nsentence in the very long test std::string.");

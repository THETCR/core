...
void gLogTestResult(string testName, bool (*testPtr)())
{
...
bool Testb_GenerateGroupParams()
{
...
void Testb_RunAllTests()
{
    ...
    cout << ggSuccessfulTests << " out of " << ggNumTests << " tests passed." << endl
         << endl;
    delete gg_Params;
}
...
{
    cout << "libzerocoin v" << ZEROCOIN_VERSION_STRING << " benchmark utility." << endl
         << endl;

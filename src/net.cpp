...
CNode* CConnman::ConnectNode(CAddress addrConnect, const char *pszDest, bool fCountFailure, bool manual_connection, bool obfuScationMaster)
{
    if (pszDest == nullptr) {
...
void CConnman::OpenMasternodeConnection(const CAddress &addrConnect) {
    return OpenNetworkConnection(addrConnect, false, nullptr, nullptr, false, false, true);
}

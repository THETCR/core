...
#ifndef PIVX_CORE_NEW_GUI_WISPRGUI_H
#define PIVX_CORE_NEW_GUI_WISPRGUI_H
...
*/
class WISPRGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit WISPRGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~WISPRGUI();
...
#endif //PIVX_CORE_NEW_GUI_WISPRGUI_H

...
QString BitcoinUnits::name(int unit, bool isZwsp)
{
    QString z = "";
    if(isZwsp) z = "z";
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case WSP:
            return z + QString("WSP");
        case mWSP:
            return z + QString("mWSP");
        case uWSP:
            return z + QString::fromUtf8("μWSP");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case WSP:
            return z + QString("tWSP");
        case mWSP:
            return z + QString("mtWSP");
        case uWSP:
            return z + QString::fromUtf8("μtWSP");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZWSP)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZWSP);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZWSP)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZWSP));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}

    ...
    platformStyle(_platformStyle)
{
    ...
    privacyPage = new PrivacyDialog(platformStyle);
...
{
    AskPassphraseDialog dlg(AskPassphraseDialog::Mode::ChangePass, this, AskPassphraseDialog::Context::ChangePass);
    dlg.setModel(walletModel);
    dlg.exec();
}
...
void WalletView::unlockWallet(AskPassphraseDialog::Context context)
{
    ...
    if (walletModel->getEncryptionStatus() == WalletModel::Locked || walletModel->getEncryptionStatus() == WalletModel::UnlockedForAnonymizationOnly) {
        AskPassphraseDialog dlg(AskPassphraseDialog::Mode::UnlockAnonymize, this, context);
        dlg.setModel(walletModel);
        dlg.exec();
    }
}
...
void WalletView::toggleLockWallet()
{
    ...
    if (encStatus == walletModel->Locked) {
        AskPassphraseDialog dlg(AskPassphraseDialog::Mode::UnlockAnonymize, this, AskPassphraseDialog::Context::ToggleLock);
        dlg.setModel(walletModel);
        dlg.exec();
    }

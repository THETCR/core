                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzWSPPathCustom = gArgs.GetArg("-zwspbackuppath", "");
    ...
    ui->wallet_path->setText(QString::fromStdString(GetDataDir().string() + QDir::separator().toLatin1() + gArgs.GetArg("-wallet", "wallet.dat")));
#else

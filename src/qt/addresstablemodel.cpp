...
struct AddressTableEntry {
    ...
    AddressTableEntry() {}
    AddressTableEntry(Type type, const QString &pubcoin):    type(type), pubcoin(std::move(pubcoin)) {}
    AddressTableEntry(Type type, const QString& label, const QString& address, const uint _creationTime) : type(type), label(std::move(label)), address(std::move(address)), creationTime(_creationTime) {}
};

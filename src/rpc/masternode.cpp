...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print bitcoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    { "bitcoin",               "masternode",             &masternode,             {} },
    { "bitcoin",               "masternodelist",         &masternodelist,         {} },
    { "bitcoin",               "masternodebroadcast",    &masternodebroadcast,    {} },
    { "bitcoin",               "getpoolinfo",            &getpoolinfo,            {} },
    { "bitcoin",               "sentinelping",           &sentinelping,           {} },
#ifdef ENABLE_WALLET
    { "bitcoin",               "privatesend",            &privatesend,            {} },
#endif // ENABLE_WALLET
};

...
static UniValue sendrawtransaction(const JSONRPCRequest& request)
{
        ...
        throw std::runtime_error(
            RPCHelpMan{"sendrawtransaction",
                ...
                "\nAlso see createrawtransaction and signrawtransactionwithkey calls.\n",
                {
                    ...
                    {"swiftx", RPCArg::Type::BOOL, /* default */ "false", "Use SwiftX to send this transaction\n"},
                       },
                RPCResult{
    ...
    RPCTypeCheck(request.params, {
        ...
        UniValue::VBOOL, // NUM or BOOL, checked later
    });
    ...
    const TransactionError err = BroadcastTransaction(tx, txid, err_string, max_raw_tx_fee, request.params[2].get_bool());

...
UniValue getblocktemplate(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 1)
        throw runtime_error(
            ...
            "       \"capabilities\":[       (array, optional) A list of std::strings\n"
            ...
            "  \"mutable\" : [                      (array of std::string) list of ways the block template may be changed \n"
...
//    result.pushKV("sizelimit", (int64_t)MAX_BLOCK_SIZE);
    ...
    result.pushKV("masternode_payments", (int64_t)(pindexPrev->nHeight + 1) >= Params().NEW_PROTOCOLS_STARTHEIGHT());

...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    /* bitcoin features */
    { "bitcoin",               "getgovernanceinfo",      &getgovernanceinfo,     {} },
    { "bitcoin",               "getsuperblockbudget",    &getsuperblockbudget,   {"index"} },
    { "bitcoin",               "gobject",                &gobject,               {} },
    { "bitcoin",               "voteraw",                &voteraw,               {} },

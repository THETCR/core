 ...
 *  For generic data types, this is *not* recursive. DynamicUsage(std::vector<std::vector<int> >)
 *  will compute the memory used for the std::vector<int>'s, but not for the ints inside.

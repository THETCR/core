...
from test_framework.test_wispr import isclose, getIndexAtProperty
from test_framework.test_framework import SkipTest
from test_framework.util import *

class USBDeviceTest(WisprTestFramework):
    ...
    def run_test(self):
        ...
        # Check that wispr has been built with USB device enabled
        ...
        if not config["components"].getboolean("ENABLE_USBDEVICE"):
            raise SkipTest("wisprd has not been built with usb device enabled.")

...
// wispr includes.
#include <..\src\script\wisprconsensus.h>
...
int main()
{
    std::cout << "wisprconsensus version: " << wisprconsensus_version() << std::endl;
    ...
    wisprconsensus_error err;
    auto op0Result = wisprconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, wisprconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);

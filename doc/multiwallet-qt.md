...
In order to support loading of multiple wallets in wispr-qt, a few changes in the UI architecture will be needed.
...
Changes to wispr.cpp
----------------------
wispr.cpp is the entry point into wispr-qt, and as such, will require some minor modifications to provide hooks for
